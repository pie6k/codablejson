...
Welcome to CodableJSON - High-performance, extensible, and declarative "anything to/from JSON" serializer.

Experiment with CodableJSON in the [playground](https://codablejson.com/playground/)

---

# Rationale

CodableJSON addresses two main problems:
...
- **📦 Lightweight**: Even with a lot of powerful features, CodableJSON API is relatively small and (hopefully) easy to understand.
...
Instead of manually converting your data to/from JSON, you can use CodableJSON to serialize and deserialize your data in declarative way by marking your classes and properties as codable.
...
class Player {
  ...
  // Constructor is optional and not needed for CodableJSON to work.
