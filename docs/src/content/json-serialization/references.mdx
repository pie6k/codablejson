...
CodableJSON checks if the same object appears multiple times in the input (including circular references) and automatically preserves object references.
...
CodableJSON handles circular references automatically:
