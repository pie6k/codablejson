...
CodableJSON provides a `copy` function that creates deep copies of any nested, complex object while preserving all types and creating new references.

## Basic Usage

```typescript
import { copy } from "codablejson";
...
<Callout type="info">
You can copy anything that is serializable by CodableJSON, including custom types and circular references.
</Callout>
