...
CodableJSON allows you to define custom serialization for your own types using `codableType` and custom `Coder` instances.
...
You don't need to worry about recursive encoding/decoding. CodableJSON will handle it for you.
