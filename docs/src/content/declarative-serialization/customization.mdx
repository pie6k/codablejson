...
CodableJSON provides flexible customization options for controlling how your classes are serialized and deserialized.
...
class ComplexType {
  ...
  // Constructor is not memberwise - CodableJSON is not able to know how to construct the instance from the encoded data.
