...
In this section, we will explore how to use CodableJSON to easily define complex and nested, serializable classes with minimal boilerplate.
...
CodableJSON offers set of tools and conventions to help you avoid the entire "data format" and automatically handle serialization of your "core" classes.
